...
public class JdbcStepExecutionDaoTests extends AbstractStepExecutionDaoTests {
	...
	public void testTruncateExitDescription() {
		...
		assertTrue(retrievedAfterSave.getExitStatus().getExitDescription()
		.length() < stepExecution.getExitStatus().getExitDescription().length(), "Exit description should be truncated");
		...
		assertTrue(retrievedAfterUpdate.getExitStatus().getExitDescription()
		.length() < stepExecution.getExitStatus().getExitDescription().length(), "Exit description should be truncated");
	}
