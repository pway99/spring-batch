...
public class StepWithFaultTolerantProcessTaskJobParserTests {
	...
	public void testStepWithTask() throws Exception {
		...
		ReflectionTestUtils.getField(factory, "propagation"), "wrong transaction-attribute:");
		assertEquals(Isolation.DEFAULT,
		ReflectionTestUtils.getField(factory, "isolation"), "wrong transaction-attribute:");
