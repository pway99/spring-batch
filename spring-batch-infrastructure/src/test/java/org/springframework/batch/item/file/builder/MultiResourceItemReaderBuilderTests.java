...
public class MultiResourceItemReaderBuilderTests extends AbstractItemStreamItemReaderTests {
	...
	public void testNullDelegate() {
		try {
			...
			assertEquals(
			"delegate is required.", ise.getMessage(), "IllegalArgumentException message did not match the expected result.");
		}
	}
	...
	public void testNullResources() {
		try {
			...
			assertEquals(
			"resources array is required.", ise.getMessage(), "IllegalArgumentException message did not match the expected result.");
		}
	}
