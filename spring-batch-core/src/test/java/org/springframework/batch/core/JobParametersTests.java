...
public class JobParametersTests {
	...
	public void testGetDouble() {
		assertEquals(Double.valueOf(1.1), Double.valueOf(parameters.getDouble("double.key1")));
		assertEquals(Double.valueOf(2.2), Double.valueOf(parameters.getDouble("double.key2")));
	}
